    ...
    <div id="wd-lab1">
      ...
      <div id="wd-lists">
        ...
        <ol id="wd-your-favorite-recipe">
          <li>Mix dry ingredients.</li>
          <li>Add Apple jam,honey,chili,avacado, whatever</li>
          <li> Bake until bubbly on top.</li>
        </ol>
      ...
      <div id="wd-images">
        ...
        <br />
        <img id="wd-teslabot" src="/tesla.webp" height="200px" />
      </div>
      <div id="wd-forms">
        <h4>Form Elements</h4>
        ...
        <br />
        {/* htmlFor attribute has the same value as the id attribute of the input field
        ...
        />
        <br />
               {/* the value is set and read-only here */}
